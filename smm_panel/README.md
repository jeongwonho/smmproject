...
- `SMM_PANEL_CAFE24_REDIRECT_URI`: 선택값. Cafe24 앱에 등록한 콜백 주소. 미설정 시 현재 도메인의 `/api/admin/cafe24/oauth/callback` 사용
...
- `SMM_PANEL_CAFE24_REDIRECT_URI`: Cafe24 OAuth 콜백 주소. 예: `https://your-domain.example/api/admin/cafe24/oauth/callback`
